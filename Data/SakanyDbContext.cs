    ...
    public class SakanyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User { ID = "O1", Name = "Ahmed Owner", Email = "ahmed@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345678", Role = (UserRole)1 },
                new User { ID = "O2", Name = "Sara Owner", Email = "sara@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345679", Role = (UserRole)1 },
                new User { ID = "O3", Name = "Mona Owner", Email = "mona@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345680", Role = (UserRole)1 },
                new User { ID = "O4", Name = "Omar Owner", Email = "omar@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345681", Role = (UserRole)1 },
                new User { ID = "O5", Name = "Zain Owner", Email = "zain@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345682", Role = (UserRole)1 },
				new User { ID = "O6", Name = "Jose Gonzales", Email = "admin@example.com", Password = new PasswordHasher().HashPassword(new User() ,"hashed_pass"), Phone = "01012345682", Role = (UserRole)0 }
            );
